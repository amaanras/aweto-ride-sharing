...
import 'package:aweto_user_app/models/prediction_model.dart';
...
class _SearchDestinationPageState extends State<SearchDestinationPage> {
  ...
  searchLocation(String locationName) async
  {
    ...
    {
      String apiPlacesUrl = "https://maps.googleapis.com/maps/api/place/autocomplete/json?input=$locationName&key=$googleMapKey&components=country:za";
